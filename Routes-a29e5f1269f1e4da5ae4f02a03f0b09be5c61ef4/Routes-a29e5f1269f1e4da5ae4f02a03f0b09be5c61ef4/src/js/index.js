...
window.onload = function (e) { 
	if (password != null && email != null) {
		TweenMax.set(armL, { x: -193, y: 220, rotation: 105, transformOrigin: "top left" });
